...
describe('shouldApplySubscriptionEvent', () => {
	it('applies the first event we have ever seen for a subscription', async () => {
	...
	it('ignores an older event, which is the whole point', async () => {
	...
	it('treats epoch zero as a real timestamp, not a missing one', async () => {
