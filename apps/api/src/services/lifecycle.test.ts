...
describe('restoreAllowed', () => {
	it('lets a recovered subscription undo the lapse it caused', () => {
		expect(restoreAllowed('subscription_canceled', 'subscription_recovered')).toBe(true);
	});

	it('lets a won dispute undo the chargeback it caused', () => {
	...
	it('does not cross the two triggers', () => {
	...
	it('treats an unknown or missing reason as not restorable', () => {
